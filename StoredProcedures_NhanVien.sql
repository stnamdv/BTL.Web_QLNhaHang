USE [NhaHang]
GO
/****** Object:  StoredProcedure [dbo].[sp_NhanVien_CanDelete]    Script Date: 9/17/2025 10:31:59 AM ******/
SET ANSI_NULLS ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_NhanVien_Create]    Script Date: 9/17/2025 10:31:59 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
    ...
    BEGIN TRY
        ...
        INSERT INTO dbo.NhanVien (ma_nv, ho_ten, loai_nv, ngay_vao_lam, trang_thai)
        VALUES (@temp_ma_nv, @ho_ten, @loai_nv, @ngay_vao_lam, @trang_thai);
...
/****** Object:  StoredProcedure [dbo].[sp_NhanVien_Delete]    Script Date: 9/17/2025 10:31:59 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_NhanVien_GetActive]    Script Date: 9/17/2025 10:31:59 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_NhanVien_GetAll]    Script Date: 9/17/2025 10:31:59 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_NhanVien_GetById]    Script Date: 9/17/2025 10:31:59 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_NhanVien_GetByLoaiNv]    Script Date: 9/17/2025 10:31:59 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_NhanVien_GetStatsByLoai]    Script Date: 9/17/2025 10:31:59 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_NhanVien_SearchByName]    Script Date: 9/17/2025 10:31:59 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_NhanVien_Update]    Script Date: 9/17/2025 10:31:59 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT 
            ...
            ho_ten, loai_nv, ngay_vao_lam, trang_thai
        FROM @NhanVienData
...
-- Tạo User-Defined Table Type cho bulk upload
CREATE TYPE [dbo].[NhanVienBulkType] AS TABLE(
...
-- Thêm unique constraint cho ma_nv (nếu chưa có)
-- Chạy lệnh này nếu cột ma_nv chưa có unique constraint
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID('dbo.NhanVien') AND name = 'UK_NhanVien_ma_nv')
BEGIN
    ALTER TABLE dbo.NhanVien ADD CONSTRAINT UK_NhanVien_ma_nv UNIQUE (ma_nv);
    PRINT N'Đã thêm unique constraint UK_NhanVien_ma_nv';
END
ELSE
BEGIN
    PRINT N'Unique constraint UK_NhanVien_ma_nv đã tồn tại';
END
GO
...
-- Description: Lấy danh sách nhân viên có phân trang
-- =============================================
...
-- Author:      System
-- Create date: 2024-01-01
-- Description: Lấy danh sách nhân viên theo loại có phân trang
-- =============================================
...
-- Author:      System
-- Create date: 2024-01-01
-- Description: Lấy danh sách nhân viên đang hoạt động có phân trang
-- =============================================
...
-- Author:      System
-- Create date: 2024-01-01
-- Description: Lấy danh sách nhân viên tìm kiếm theo tên có phân trang
-- =============================================
...
BEGIN
    ...
    FROM dbo.NhanVien nv
    INNER JOIN dbo.LoaiNhanVien lnv ON nv.loai_nv = lnv.loai_nv
    WHERE nv.ho_ten LIKE '%' + @search_term + '%';
