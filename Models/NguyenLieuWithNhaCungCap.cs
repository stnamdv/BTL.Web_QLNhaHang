...
namespace BTL.Web.Models
{
    public class NguyenLieuWithNhaCungCap
    {
        ...
        public int so_lan_nhap { get; set; }
        public decimal tong_so_luong_nhap { get; set; }
        public decimal gia_trung_binh { get; set; }
        public DateTime? lan_nhap_cuoi { get; set; }
        public DateTime? lan_nhap_dau { get; set; }
